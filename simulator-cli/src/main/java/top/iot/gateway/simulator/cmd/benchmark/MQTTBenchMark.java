...
import top.iot.gateway.simulator.core.network.mqtt.MqttOptions;
...
class MQTTBenchMark extends AbstractBenchmarkCommand implements Runnable {
    ...
    static class MqttCommandOptions extends top.iot.gateway.simulator.core.network.mqtt.MqttOptions {
